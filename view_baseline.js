...
obj_name_div = $('<div id="permdialog_objname" class="section">Viewing: <span id="permdialog_objname_namespan"></span> </div>')
...
perm_add_user_select = define_new_user_select_field('perm_add_user', 'Add to Group', on_user_change = function(selected_user){
    // console.log("add...")
...
perm_remove_user_button  = $('<button id="perm_remove_user" class="ui-button ui-widget ui-corner-all">Remove from Group</button>')
...
perm_dialog.append($('<div id="permissions_user_title">Select group or user:</div>'))
...
define_attribute_observer(perm_dialog, 'filepath', function(){
    ...
    file_user_list = make_user_list('permdialog_file_user', file_users, true, true)
...
$('#adv_perm_inheritance').change(function(){
    ...
    if( $('#adv_perm_inheritance').prop('checked')) {
        ...
        $(`<div id="add_remove_cancel" title="Security">
                <div class="adv-dialog-message">
                    <p class="adv-dialog-warning">
                        <strong>Warning:</strong> If you continue, inheritable permissions will no longer propagate to this object.
                    </p>

                    <ul class="adv-dialog-list">
                        <li><strong>Add</strong> converts inherited parent permissions into explicit permissions on this object.</li>
                        <li><strong>Remove</strong> removes inherited parent permissions from this object.</li>
                        <li><strong>Cancel</strong> keeps the current inheritance settings unchanged.</li>
                    </ul>
                </div>
        ...
        $(`<div id="replace_perm_dialog" title="Security">
                <div class="adv-dialog-message">
                    <p>
                        ...
                        with inheritable permissions from <strong>${file_obj.filename}</strong>.
                    </p>
                    <p class="adv-dialog-warning">Do you want to continue?</p>
                </div>
            </div>`).dialog({
            modal: true,
            position: { my: "top", at: "top", of: $('#html-loc') },
